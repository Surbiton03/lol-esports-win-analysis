...
The cleaned dataset contains **190 rows** (where each row represents a single professional match played by T1). The columns most relevant to answering our central question are described below:
